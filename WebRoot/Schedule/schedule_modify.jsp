...
<html>
  ...
  <tr>
    <td height="168" colspan="5" align="center">
    	...
    	<table border="1" width="70%">
    		...
    		<s:iterator value="scList" var="sc">
    			<tr>
    				...
    				<td><a href="Schedule/schedule_update.jsp?id=<s:property value="#sc.id"/>">编辑</a></td>
    				<s:url var="delete" value="schedule/schedule_delete">
    					<s:param name="deleteid" value="#sc.id"/>
    				</s:url>
    	...
    	<!-- 分页模块 -->
    	<s:url var="url_pageNow" value="schedule/schedule_modify">
   		<s:param name="pageNow" value="pageNow"/>
   		</s:url>
    	<s:url var="url_next" value="schedule/schedule_modify">
   		<s:param name="pageNow" value="pageNow+1"/>
   		</s:url>
   		<s:url var="url_pre" value="schedule/schedule_modify">
   			<s:param name="pageNow" value="pageNow-1"/>
   		</s:url>
